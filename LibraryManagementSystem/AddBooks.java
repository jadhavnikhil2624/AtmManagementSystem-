...
public class AddBooks extends JFrame implements ActionListener {
    ...
    public AddBooks() {
        ...
        comboBox.setBounds(173, 186, 194, 220);
        ...
        b2.setBorder(new CompoundBorder(new LineBorder(new Color(128, 128, 128)), null));
        ...
        panel.setBorder(new TitledBorder(new LineBorder(new Color(138, 434, 226), 2), "Add Books", TitledBorder.LEADING,
