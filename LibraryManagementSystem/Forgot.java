...
public class Forgot extends JFrame implements ActionListener {
    ...
    public Forgot() {
        ...
        t2.setFont(new Font("Tahome", Font.BOLD, 13));
        ...
        t3.setFont(new Font("Tahome", Font.BOLD, 12));
        ...
        t4.setFont(new Font("Tahome", Font.BOLD, 13));
        ...
        t5.setFont(new Font("Tahome", Font.BOLD, 13));
        ...
        b3.setBounds(428, 83, 80, 29);
        b3.setBackground(Color.BLACK);
        b3.setForeground(Color.WHITE);
        contentPane.add(b3);

        JPanel panel = new JPanel();
        panel.setBorder(new TitledBorder(new LineBorder(new Color(139, 49, 19), 2), "Forgot-Panel",
