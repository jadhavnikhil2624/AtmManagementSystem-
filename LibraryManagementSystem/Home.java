...
import LibraryManagementSystem.AddBooks;
import LibraryManagementSystem.AddStudent;

import LibraryManagementSystem.login_user;
...
public class Home extends JFrame implements ActionListener {
    ...
    public Home() {
        ...
        menuBar.setBorder(new EtchedBorder(EtchedBorder.LOWERED, new Color(0, 128, 0), new Color(138, 128, 128)));
        menuBar.setBackground(Color.CYAN);
        menuBar.setBounds(0, 10, 1000, 35);
        contentPane.add(menuBar);

        JMenu mnExit = new JMenu("Exit");
        mnExit.setFont(new Font("Trebuche", Font.BOLD, 17));
        ...
        bookdetails.setForeground(new Color(105, 105, 105));
        bookdetails.setBackground(Color.DARK_GRAY);
        mnHelp.add(bookdetails);

        JMenuItem StudentDetails = new JMenuItem("Student Details");
        StudentDetails.setForeground(new Color(105, 105, 105));
        StudentDetails.setBackground(Color.DARK_GRAY);
        StudentDetails.addActionListener(this);
        mnHelp.add(StudentDetails);
        ...
        l1.setFont(new Font("Serge UI Semilight", Font.BOLD, 30));
        l1.setBounds(268, 30, 701, 80);
        contentPane.add(l1);

        JLabel l2 = new JLabel("");
        l2.setVerticalAlignment(SwingConstants.TOP);
        ImageIcon i1 = new ImageIcon(ClassLoader.getSystemResource("Include Image here"));
        ...
        ImageIcon i4 = new ImageIcon(ClassLoader.getSystemResource("Include Image here"));
        ...
        ImageIcon i7 = new ImageIcon(ClassLoader.getSystemResource("Include Image here"));
        Image i8 = i7.getImage().getScaledInstance(200, 200, Image.SCALE_DEFAULT);
        ImageIcon i9 = new ImageIcon(i8);
        l4 = new JLabel(i9);
        l4.setBounds(60, 140, 159, 152);
        contentPane.add(l4);
        ...
        panel.setBorder(
                new TitledBorder(new LineBorder(new Color(250, 128, 114), 2), "Opearation", TitledBorder.LEADING,
        ...
        ImageIcon i10 = new ImageIcon(ClassLoader.getSystemResource("Include Image here"));
        Image i11 = i10.getImage().getScaledInstance(150, 150, Image.SCALE_DEFAULT);
        ImageIcon i12 = new ImageIcon(i11);
        l5 = new JLabel(i12);
        l5.setBounds(60, 140, 159, 152);
        contentPane.add(l5);

        JLabel l6 = new JLabel("");
        ImageIcon i13 = new ImageIcon(ClassLoader.getSystemResource("Include Image here"));
        Image i14 = i13.getImage().getScaledInstance(150, 150, Image.SCALE_DEFAULT);
        ImageIcon i15 = new ImageIcon(i14);
        l6 = new JLabel(i15);
        l6.setBounds(60, 140, 159, 152);
        contentPane.add(l6);

        JLabel l7 = new JLabel("");
        ImageIcon i16 = new ImageIcon(ClassLoader.getSystemResource("Include Image here"));
        Image i17 = i16.getImage().getScaledInstance(150, 150, Image.SCALE_DEFAULT);
        ImageIcon i18 = new ImageIcon(i17);
        l7 = new JLabel(i18);
        l7.setBounds(60, 140, 159, 152);
        contentPane.add(l7);

        JPanel panel2 = new JPanel();
        panel2.setBorder(
                new TitledBorder(new LineBorder(new Color(205, 133, 63), 2), "Action", TitledBorder.LEADING,
                        TitledBorder.TOP, null, new Color(233, 150, 122)));
        panel2.setBounds(20, 120, 750, 260);
