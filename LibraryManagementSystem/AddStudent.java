...
public class AddStudent extends JFrame implements ActionListener {
    ...
    public AddStudent() {
        ...
        t2.setColumns(10);
        t2.setBounds(174, 66, 156, 20);
        contentPane.add(t2);

        comboBox = new JComboBox();
        comboBox.setModel(new DefaultComboBoxModel(
                new String[] { "Mechnical", "CSE", "IT", "Civil", "Automobile", "EEE", "Other" }));

        comboBox.setForeground(new Color(47, 79, 79));
        comboBox.setFont(new Font("Trebutchet MS", Font.BOLD, 14));
        comboBox.setBounds(176, 211, 154, 20);
        contentPane.add(comboBox);

        comboBox_1 = new JComboBox();
        comboBox_1.setModel(new DefaultComboBoxModel(
                new String[] { "First", "Second", "Third", "Four" }));

        comboBox_1.setForeground(new Color(47, 79, 79));
        comboBox_1.setFont(new Font("Trebutchet MS", Font.BOLD, 14));
        ...
        comboBox_2.setFont(new Font("Trebutchet MS", Font.BOLD, 14));
        ...
        comboBox_3.setModel(new DefaultComboBoxModel(
                new String[] { "B.E", "B.Tech", "M.Tech", "MBA", "BBA", "B.SC", "M.SC", "B.com", "M.com" }));

        comboBox_3.setForeground(new Color(47, 79, 79));
        comboBox_3.setFont(new Font("Trebutchet MS", Font.BOLD, 14));
        comboBox_3.setBounds(176, 277, 154, 20);
        contentPane.add(comboBox_3);

        JPanel panel = new JPanel();
        panel.setBorder(
                new TitledBorder(new LineBorder(new Color(102, 205, 170), 2, true), "Add-Student", TitledBorder.LEADING,
    ...
    public void actionPerformed(ActionEvent ae) {
        try {
            ...
            if (ae.getSource() == b1) {
                try {
                    conn con = new conn();
                    String sql = "insert into student(student_id,name,father,course,year,semester)values(?,?,?,?,?,?,?,)";
